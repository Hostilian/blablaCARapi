package com.hostilian.blablacarapi.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.hostilian.blablacarapi.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.hostilian.blablacarapi.security.DomainUserDetailsService", "createSpringSecurityUser");
